...
#include "tiny_image_format_base.h"
...
TIF_CONSTEXPR ALWAYS_INLINE uint64_t TinyImageFormat_Code(TinyImageFormat const fmt) {
	switch (fmt) {
...
TIF_CONSTEXPR ALWAYS_INLINE bool TinyImageFormat_IsDepthOnly(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_D16_UNORM:
			return true;
		case TinyImageFormat_X8_D24_UNORM:
...
TIF_CONSTEXPR ALWAYS_INLINE bool TinyImageFormat_IsStencilOnly(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_S8_UINT:
			return true;
		default:
...
TIF_CONSTEXPR ALWAYS_INLINE bool TinyImageFormat_IsDepthAndStencil(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_D16_UNORM_S8_UINT:
			return true;
		case TinyImageFormat_D24_UNORM_S8_UINT:
...
TIF_CONSTEXPR ALWAYS_INLINE bool TinyImageFormat_IsCLUT(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_CLUT_P4:
			return true;
		case TinyImageFormat_CLUT_P4A4:
...
TIF_CONSTEXPR ALWAYS_INLINE bool TinyImageFormat_IsFloat(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_R16_SFLOAT:
			return true;
		case TinyImageFormat_R16_SBFLOAT:
...
TIF_CONSTEXPR ALWAYS_INLINE bool TinyImageFormat_IsNormalised(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_R1_UNORM:
			return true;
		case TinyImageFormat_R2_UNORM:
...
TIF_CONSTEXPR ALWAYS_INLINE bool TinyImageFormat_IsSigned(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_R8_SNORM:
			return true;
		case TinyImageFormat_R8_SINT:
...
TIF_CONSTEXPR ALWAYS_INLINE bool TinyImageFormat_IsSRGB(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_R8_SRGB:
			return true;
		case TinyImageFormat_R8G8_SRGB:
...
TIF_CONSTEXPR ALWAYS_INLINE bool TinyImageFormat_IsCompressed(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_DXBC1_RGB_UNORM:
			return true;
		case TinyImageFormat_DXBC1_RGB_SRGB:
...
TIF_CONSTEXPR ALWAYS_INLINE bool TinyImageFormat_IsHomogenous(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_UNDEFINED:
			return false;
		case TinyImageFormat_B2G3R3_UNORM:
...
TIF_CONSTEXPR ALWAYS_INLINE uint32_t TinyImageFormat_WidthOfBlock(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_UNDEFINED:
			return 0;
		case TinyImageFormat_R1_UNORM:
...
TIF_CONSTEXPR ALWAYS_INLINE uint32_t TinyImageFormat_HeightOfBlock(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_UNDEFINED:
			return 0;
		case TinyImageFormat_DXBC1_RGB_UNORM:
...
TIF_CONSTEXPR ALWAYS_INLINE uint32_t TinyImageFormat_DepthOfBlock(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_UNDEFINED:
			return 0;
		default:
...
TIF_CONSTEXPR ALWAYS_INLINE uint32_t TinyImageFormat_BitSizeOfBlock(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_UNDEFINED:
			return 0;
		case TinyImageFormat_R1_UNORM:
...
TIF_CONSTEXPR ALWAYS_INLINE uint32_t TinyImageFormat_ChannelCount(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_UNDEFINED:
			return 0;
		case TinyImageFormat_R1_UNORM:
...
TIF_CONSTEXPR ALWAYS_INLINE uint32_t
TinyImageFormat_ChannelBitWidthAtPhysical(TinyImageFormat const fmt, uint32_t const channel) {
...
TIF_CONSTEXPR ALWAYS_INLINE double TinyImageFormat_MinAtPhysical(TinyImageFormat const fmt, uint32_t const channel) {
	if (TinyImageFormat_IsHomogenous(fmt) || channel == 0) {
		switch (fmt) {
			case TinyImageFormat_R8_SNORM:
				return -1.000000;
...
TIF_CONSTEXPR ALWAYS_INLINE double TinyImageFormat_MaxAtPhysical(TinyImageFormat const fmt, uint32_t const channel) {
	if (TinyImageFormat_IsHomogenous(fmt) || channel == 0) {
		switch (fmt) {
			case TinyImageFormat_UNDEFINED:
				return 0.000000;
...
TIF_CONSTEXPR ALWAYS_INLINE TinyImageFormat_LogicalChannel
TinyImageFormat_PhysicalChannelToLogical(TinyImageFormat const fmt, int8_t const channel) {
...
TIF_CONSTEXPR ALWAYS_INLINE int8_t
TinyImageFormat_LogicalChannelToPhysical(TinyImageFormat const fmt, TinyImageFormat_LogicalChannel const channel) {
...
TIF_CONSTEXPR ALWAYS_INLINE char const *const TinyImageFormat_Name(TinyImageFormat const fmt) {
	switch (fmt) {
		case TinyImageFormat_UNDEFINED:
			return "UNDEFINED";
		case TinyImageFormat_R1_UNORM:
...
ALWAYS_INLINE TinyImageFormat TinyImageFormat_FromName(char const *p) {
...
// Helpers
TIF_CONSTEXPR ALWAYS_INLINE uint32_t TinyImageFormat_PixelCountOfBlock(TinyImageFormat const fmt) {
	return TinyImageFormat_WidthOfBlock(fmt) * TinyImageFormat_HeightOfBlock(fmt) * TinyImageFormat_DepthOfBlock(fmt);
}

TIF_CONSTEXPR ALWAYS_INLINE double
TinyImageFormat_Min(TinyImageFormat const fmt, TinyImageFormat_LogicalChannel const channel) {
	return TinyImageFormat_MinAtPhysical(fmt, TinyImageFormat_LogicalChannelToPhysical(fmt, channel));
}

TIF_CONSTEXPR ALWAYS_INLINE double
TinyImageFormat_Max(TinyImageFormat const fmt, TinyImageFormat_LogicalChannel const channel) {
	return TinyImageFormat_MaxAtPhysical(fmt, TinyImageFormat_LogicalChannelToPhysical(fmt, channel));
}

TIF_CONSTEXPR ALWAYS_INLINE uint32_t
TinyImageFormat_ChannelBitWidth(TinyImageFormat const fmt, TinyImageFormat_LogicalChannel const channel) {
