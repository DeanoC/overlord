...
class UnconnectedBusSpec extends AnyFlatSpec with Matchers with MockitoSugar with SilentLogger {
  ...
  it should "use the specified bus protocol" in {
    ...
    withProtocol.busProtocol shouldBe "axi4"
    defaultProtocol.busProtocol shouldBe "default"
  }
  ...
  it should "use the specified bus names" in {
    ...
    withNames.supplierBusName shouldBe "main_bus"
    withNames.consumerBusName shouldBe "mem_bus"
    defaultNames.supplierBusName shouldBe ""
    defaultNames.consumerBusName shouldBe ""
  }
