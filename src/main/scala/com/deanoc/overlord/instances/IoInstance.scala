...
//    config: com.deanoc.overlord.config.IoConfig // Store the specific config
  ...
  override def isVisibleToSoftware: Boolean = true;//config.visible_to_software // Use visible_to_software from the specific config
}
...
//      config: com.deanoc.overlord.config.IoConfig // Accept IoConfig
    ...
    Left("TODO: Implement IoInstance creation")
    /*  
    try {
