...
static PSI_IWord const put_serdes_in_reset_init[] = {
	...
	PSI_WRITE_MASKED_32(DP, DP_TX_PHY_POWER_DOWN, 0x0000000FU, 0x0000000AU),
	PSI_WRITE_MASKED_32(DP, DP_PHY_RESET, 0x00000002U, 0x00000002U),
...
static PSI_IWord const serdes_init[] = {
	...
	PSI_WRITE_MASKED_32(SERDES, PLL_REF_SEL0, 0x0000001FU, 0x0000000DU),
	PSI_WRITE_MASKED_32(SERDES, PLL_REF_SEL1, 0x0000001FU, 0x00000008U),
	PSI_WRITE_MASKED_32(SERDES, PLL_REF_SEL2, 0x0000001FU, 0x00000009U),
	PSI_WRITE_MASKED_32(SERDES, PLL_REF_SEL3, 0x0000001FU, 0x00000009U),
	...
	PSI_WRITE_MASKED_32(SERDES, ICM_CFG0, 0x00000077U, 0x00000031U),
	PSI_WRITE_MASKED_32(SERDES, ICM_CFG1, 0x00000077U, 0x00000044U),
...
static PSI_IWord const take_serdes_out_of_reset_init[] = {
	...
	PSI_FAR_WRITE_MASKED_32(DP,DP_PHY_RESET, 0x00000002U, 0x00000000U),
	PSI_FAR_WRITE_MASKED_32(DP,DP_TX_PHY_POWER_DOWN, 0x0000000FU, 0x00000000U),
	...
	PSI_SET_REGISTER_BANK(PCIE_ATTRIB),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_25, 0x00000200U, 0x00000200U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_7, 0x0000FFFFU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_8, 0x0000FFFFU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_9, 0x0000FFFFU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_10, 0x0000FFFFU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_11, 0x0000FFFFU, 0x0000FFFFU),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_12, 0x0000FFFFU, 0x000000FFU),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_13, 0x0000FFFFU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_14, 0x0000FFFFU, 0x0000FFFFU),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_15, 0x0000FFFFU, 0x0000FFF0U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_16, 0x0000FFFFU, 0x0000FFF0U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_17, 0x0000FFFFU, 0x0000FFF1U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_18, 0x0000FFFFU, 0x0000FFF1U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_27, 0x00000738U, 0x00000100U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_50, 0x0000FFF0U, 0x00000040U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_105, 0x000007FFU, 0x000000CDU),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_106, 0x00003FFFU, 0x00000624U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_107, 0x000007FFU, 0x00000018U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_108, 0x000007FFU, 0x000000B5U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_109, 0x0000FFFFU, 0x00007E20U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_34, 0x000000FFU, 0x00000001U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_53, 0x000000FFU, 0x00000060U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_41, 0x000003FFU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_97, 0x00000FFFU, 0x00000041U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_100, 0x00000040U, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_101, 0x0000FFE2U, 0x0000FFE2U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_37, 0x00007E00U, 0x00004A00U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_93, 0x0000FFFFU, 0x00009000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ID, 0xFFFFFFFFU, 0x10EED011U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, SUBSYS_ID, 0xFFFFFFFFU, 0x10EE0007U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, REV_ID, 0x000000FFU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_24, 0x0000FFFFU, 0x00008000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_25, 0x000001FFU, 0x00000006U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_4, 0x00001000U, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_89, 0x00001FFEU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_79, 0x00000020U, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_43, 0x00000100U, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_48, 0x000007FFU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_46, 0x0000FFFFU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_47, 0x00001FFFU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_44, 0x0000FFFFU, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_45, 0x0000FFF8U, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, CB, 0x00000002U, 0x00000000U),
	PSI_WRITE_MASKED_32(PCIE_ATTRIB, ATTR_35, 0x0000B000U, 0x00008000U),
	...
	PSI_SET_REGISTER_BANK(SERDES),
	PSI_POLL_MASKED_32(SERDES, L0_PLL_STATUS_READ_1, 0x00000010U),
// TODO USB3 serdes is not locking to its PLL
//	PSI_POLL_MASKED_32(SERDES, L1_PLL_STATUS_READ_1, 0x00000010U),
	PSI_POLL_MASKED_32(SERDES, L3_PLL_STATUS_READ_1, 0x00000010U),
...
#define SERDES_UNKNOWN0_OFFSET   			0x289C
#define SERDES_POWER_GOOD_OFFSET 			0x2B1C
#define SERDES_PMOS_CODE_OFFSET  			0xEF18
#define SERDES_NMOS_CODE_OFFSET  			0xEF1C
#define SERDES_MPHY_CODE_OFFSET  			0xEF20
#define SERDES_ICAL_CODE_OFFSET  			0xEF24
#define SERDES_RX_CODE_OFFSET    			0xEF28
#define SERDES_USB2_CODE_OFFSET  		 	0xEF2C

#define SERDES_L3_TM_CALIB_DIG14_OFFSET  	0xEC38
#define SERDES_L3_TM_CALIB_DIG15_OFFSET  	0xEC3C
#define SERDES_L3_TM_CALIB_DIG16_OFFSET  	0xEC40
#define SERDES_L3_TM_CALIB_DIG20_OFFSET  	0xEC50
...
void serdes_fixcal(void)
{
	...
	do {
		//Clear ICM_CFG value
		HW_REG_SET(SERDES_PLL, ICM_CFG0, 0x00000000);
		HW_REG_SET(SERDES_PLL, ICM_CFG1, 0x00000000);

		//Set ICM_CFG value
		//This will trigger re-calibration of all stages
		HW_REG_SET(SERDES_PLL, ICM_CFG0, 0x00000001);
		HW_REG_SET(SERDES_PLL, ICM_CFG1, 0x00000000);
