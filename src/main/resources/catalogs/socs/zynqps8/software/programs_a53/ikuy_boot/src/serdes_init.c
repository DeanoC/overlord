...
static PSI_IWord const take_serdes_out_of_reset_init[] = {
	...
	// lane 0 = PCIE_GEN2
	PSI_SET_REGISTER_BANK(SERDES),
	PSI_POLL_MASKED_32(SERDES, L0_PLL_STATUS_READ_1, HW_REG_FIELD_MASK(SERDES, L0_PLL_STATUS_READ_1, PLL_LOCK_STATUS_READ) ),
//	PSI_POLL_MASKED_32(SERDES, L1_PLL_STATUS_READ_1, HW_REG_FIELD_MASK(SERDES, L1_PLL_STATUS_READ_1, PLL_LOCK_STATUS_READ) ),
//	PSI_POLL_MASKED_32(SERDES, L2_PLL_STATUS_READ_1, HW_REG_FIELD_MASK(SERDES, L2_PLL_STATUS_READ_1, PLL_LOCK_STATUS_READ) ),
