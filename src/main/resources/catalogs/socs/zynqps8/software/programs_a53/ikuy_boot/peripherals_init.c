...
static PSI_IWord const peripherals_init[] = {
	...
	PSI_SET_REGISTER_BANK(UART0),
	PSI_WRITE_MASKED_32(UART0, BAUD_RATE_DIVIDER, 0x000000FFU, 0x00000006U),
	PSI_WRITE_MASKED_32(UART0, BAUD_RATE_GEN, 0x0000FFFFU, 0x0000007CU),
	PSI_WRITE_MASKED_32(UART0, CONTROL, 0x000001FFU, 0x00000017U),
	PSI_WRITE_MASKED_32(UART0, MODE, 0x000003FFU, 0x00000020U),
