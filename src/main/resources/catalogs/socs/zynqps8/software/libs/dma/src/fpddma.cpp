...
AsyncToken SimpleDmaSet(const Channels channel, const uint32_t data, uintptr_all_t address, uint32_t size) {
	...
	uintptr_lo_t baseAddr = FPD_DMA_CH0_BASE_ADDR;
	switch (channel) {
		case Channels::ChannelZero: baseAddr = FPD_DMA_CH0_BASE_ADDR;
			break;
		case Channels::ChannelOne: baseAddr = FPD_DMA_CH1_BASE_ADDR;
			break;
		case Channels::ChannelTwo: baseAddr = FPD_DMA_CH2_BASE_ADDR;
			break;
		case Channels::ChannelThree: baseAddr = FPD_DMA_CH3_BASE_ADDR;
			break;
		case Channels::ChannelFour: baseAddr = FPD_DMA_CH4_BASE_ADDR;
			break;
		case Channels::ChannelFive: baseAddr = FPD_DMA_CH5_BASE_ADDR;
			break;
		case Channels::ChannelSix: baseAddr = FPD_DMA_CH6_BASE_ADDR;
			break;
		case Channels::ChannelSevern: baseAddr = FPD_DMA_CH7_BASE_ADDR;
			break;
	}
...
void StallForToken(AsyncToken token) {
	...
	hw_RegWrite(baseAddr,
							ZDMA_REG(ZDMA_CH_ISR),
							hw_RegRead(baseAddr, ZDMA_REG(ZDMA_CH_ISR)) & ~ZDMA_ZDMA_CH_ISR_DMA_DONE);
