...
ALWAYS_INLINE WARN_UNUSED_RESULT uint32_t hw_RegRead(const uintptr_t addr, const uint32_t offset_in_bytes) { return *(((const volatile uint32_t *)addr) + offset_in_bytes/sizeof(uint32_t)); }
