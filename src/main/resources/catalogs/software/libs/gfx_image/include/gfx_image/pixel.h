...
EXTERN_C inline void Image_PixelClampF(Image_PixelF *pixel, float const min[4], float const max[4]) {
...
EXTERN_C inline void Image_PixelClampD(Image_PixelD *pixel, double const min[4], double const max[4]) {
