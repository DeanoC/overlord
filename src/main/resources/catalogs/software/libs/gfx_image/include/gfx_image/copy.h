...
Image_ImageHeader const * Image_PreciseConvert(Image_ImageHeader const * src, TinyImageFormat const newFormat);
Image_ImageHeader const * Image_FastConvert(Image_ImageHeader const * src, TinyImageFormat const newFormat, bool allowInplace);
